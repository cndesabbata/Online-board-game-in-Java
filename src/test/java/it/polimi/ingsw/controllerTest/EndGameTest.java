...
public class EndGameTest {
    ...
    public void DrawEndGameTest() {
        ...
        leaderCard11.setPlayed(true);
        player1.addLeaderCard(leaderCard11);
        player2.addLeaderCard(leaderCard11);
        LeaderCard leaderCard12 = new LeaderCard(2, null, Resource.SHIELD, LeaderType.DISCOUNT);
        leaderCard12.setPlayed(true);
        player1.addLeaderCard(leaderCard12);
        player2.addLeaderCard(leaderCard12);
        player1.getBoard().getItinerary().setCardStatus(CardStatus.FACE_UP, 0);
        player1.getBoard().getItinerary().setCardStatus(CardStatus.FACE_UP, 1);
        player1.getBoard().getItinerary().setCardStatus(CardStatus.DISCARDED, 2);
        ...
        player1Ds.get(1).add(new DevCard(null, 12, 3, Colour.YELLOW, null, null));
        player1Ds.get(2).add(new DevCard(null, 3, 1, Colour.PURPLE, null, null));
        player2Ds.get(0).add(new DevCard(null, 1, 1, Colour.GREEN, null, null));
        player2Ds.get(0).add(new DevCard(null, 6, 2, Colour.PURPLE, null, null));
        player2Ds.get(1).add(new DevCard(null, 4, 1, Colour.PURPLE, null, null));
        player2Ds.get(1).add(new DevCard(null, 5, 2, Colour.GREEN, null, null));
        player2Ds.get(1).add(new DevCard(null, 12, 3, Colour.YELLOW, null, null));
        player2Ds.get(2).add(new DevCard(null, 3, 1, Colour.PURPLE, null, null));
        gameController.endGame();
